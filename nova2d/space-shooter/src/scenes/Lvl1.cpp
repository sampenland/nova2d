...
namespace spaceshooter
{
	...
	void Lvl1::Start()
	{
		Player* player = new Player("player", Vec2((int)Game::s_Width / 2 - 8, (int)Game::s_Height - 64), Vec2Int(16, 16), 1);
		...
		Leader* leader = new Leader("leader", Vec2((int)Game::s_Width / 2 - 8, -48), Vec2Int(16, 16), 1);
		...
		TimeEffector* te = new TimeEffector(Vec2(Game::s_Width / 2 - 128, Game::s_Height - 256), 0.25f, 0, Rect(0, 0, 256, 128), TimeEffectorType::Rect);
