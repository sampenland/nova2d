...
namespace spaceshooter
{
		...
		Collider(0)
	{
		...
		if (ptrToRadius)
		{
			m_TweenID = n2dTweenAdd(false, ptrToRadius, (float)effectRadius, 1.0f, 1000.f, true, true, TweenTypes::EaseInCubic);
		}
	...
	void TimeWarp::PickupAndExpand()
	{
		...
		if (ptrToRadius)
		{
			m_TweenID = n2dTweenAdd(false, ptrToRadius, 1.0f, (float)m_EffectRadius, 600.0f, false, true, TweenTypes::EaseInCubic);;
		}
